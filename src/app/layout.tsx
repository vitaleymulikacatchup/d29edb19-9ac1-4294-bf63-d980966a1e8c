...
export const metadata: Metadata = {
  title: "Ristorante Roma - Autentica Cucina Italiana di Lusso",
  description: "Scopri l'autentica cucina italiana nel cuore di Roma. Ristorante di lusso con ricette tradizionali, ingredienti premium e atmosfera raffinata. Prenota ora.",
  keywords: "ristorante italiano Roma, cucina autentica, lusso, pasta tartufo, risotto, osso buco, prenotazione ristorante",
  metadataBase: new URL("https://ristoranteroma.com"),
  alternates: {
    canonical: "https://ristoranteroma.com"
  },
  openGraph: {
    title: "Ristorante Roma - Autentica Cucina Italiana di Lusso",
    description: "Scopri l'autentica cucina italiana nel cuore di Roma. Ristorante di lusso con ricette tradizionali e atmosfera raffinata.",
    url: "https://ristoranteroma.com",
    siteName: "Ristorante Roma",
    images: [{
      url: "https://images.pexels.com/photos/27822830/pexels-photo-27822830.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "Elegant Italian restaurant interior in Rome"
    }],
    type: "website"
  },
  twitter: {
    card: "summary_large_image",
    title: "Ristorante Roma - Autentica Cucina Italiana",
    description: "Scopri l'autentica cucina italiana nel cuore di Roma. Prenota la tua esperienza culinaria di lusso.",
